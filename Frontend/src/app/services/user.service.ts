...
export class UserService {
  ...
  public add(userData: User): Observable<User> {
    return this.httpClient.post(this.userURL + 'add', userData, header);
  }

  public modify(userData: User, id: number): Observable<any> {
    return this.httpClient.put(this.userURL + `modify/${id}`, userData, header);
  }
